...
export const BentoGridItem = ({
  ...
  const leftLists = ["Azure", "Databricks", "GCP"];
  const rightLists = ["BigQuery", "GIT", "Terraform"];
  ...
  const handleCopy = () => {
    const text = "fvincent.michot@gmail.com";
      ...
      >
        ...
        <div
          className={`absolute right-0 -bottom-5 ${
            id === 5 && "w-full opacity-80 max-sm:opacity-40"
          } `}
        >
          {spareImg && (
            <img
